  ...
  return (
    <div className=" max-w-[700px] mx-auto flex flex-col justify-between h-full w-full gap-4">
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <img className="object-cover" src={companyIcon} alt="" />
          <Input otherStyle="border-black" name="company" value={jobDetails.company} handleChange={setJobDetails} placeholder="Input company here" />
        </div>
      </div>
      <div>
        <p>Salary (PHP)</p>
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          ...
          <select
            ...
            className="border-black border-[1px] p-2 text-sm rounded w-full"
          >
      ...
      <div>
        ...
        <div className="flex items-center gap-2">
          <img className="object-cover" src={companyIcon} alt="" />
          <Input otherStyle="border-black" name="url" value={jobDetails.url} handleChange={setJobDetails} placeholder="Input site here" />
        </div>
      </div>
      <div className="relative">
        ...
        <textarea
          ...
          className="p-2  text-sm focus:outline-none resize-none border-[1px] border-black w-full h-36"
        ></textarea>
